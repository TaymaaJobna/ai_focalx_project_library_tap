...
const LibraryCard = ({ header_title, header_sub_title, first_img, sec_img, th_img, tjo_users_imag1, tjo_users_imag2, tjo_users_imag3, tjo_users_imag4, tjo_visible, number }) => {
    return (
        <>
            {/* Card */}
            < div className="tjo_card" >
                ...
                <div div className="tjo_card_header" >
                    <span className="tjo_header_title">{header_title}</span>
                    <p className="tjo_header_subtitle">{header_sub_title}</p>
                </div>

                {/* card images */}
                <div div className="tjo_card_images" >
                    <img src={first_img} alt="astronaut_pic" className="tjo_first_img" />
                    <img src={sec_img} alt="astronaut_pic" className="tjo_sec_img" />
                    <img src={th_img} alt="astronaut_pic" className="tjo_th_img" />
                </div>
